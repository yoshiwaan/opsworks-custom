...
include_recipe 'apache24::mod_authz_default' if node[:apache][:version] == '2.2'
...
include_recipe 'apache24::mod_log_config' if platform_family?('rhel')
